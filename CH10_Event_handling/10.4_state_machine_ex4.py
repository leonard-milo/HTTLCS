...
def advance_state_machine():
    ...
    if state_num == 0:       # Transition from state 0 to state 1
        redturtle.fillcolor(q4light[state_num][0])
        orgturtle.fillcolor(q4light[state_num][1])
        gturtle.fillcolor(q4light[state_num][2])
        state_num = 1
...
def main():
    ...
    draw_orglight()
    draw_redlight()
    global state_num, q4light
    state_num = 0
    q4light = [["black", "black", "green"],["black", "orange", "black"],["red", "black", "black"]]
